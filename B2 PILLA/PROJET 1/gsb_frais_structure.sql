...
CREATE TABLE IF NOT EXISTS `Visiteur` (
  ...
  FOREIGN KEY (`idVisiteur`) REFERENCES Employe(`idEmploye`)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `Directeur` (
  `idDirecteur` char(4) NOT NULL,
  PRIMARY KEY (`idDirecteur`),
  FOREIGN KEY (`idDirecteur`) REFERENCES Employe(`idEmploye`)
...
CREATE TABLE IF NOT EXISTS `Comptable` (
  ...
  FOREIGN KEY (`idComptable`) REFERENCES Employe(`idEmploye`)
) ENGINE=InnoDB;
