...
//if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['btnFHF']))// && isset($_SESSION['visiteur']))
    {
        $libelle = filter_input(INPUT_POST, 'libelle', FILTER_SANITIZE_STRING) ;
        $montant = filter_input(INPUT_POST, 'montant', FILTER_SANITIZE_STRING) ;
        if(!empty($libelle) && !empty($montant))
        {
...
?>
<div class="container">
    <h3 class="frais"><p>Saisie des frais hors forfait <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-currency-euro" viewBox="0 0 16 16">
