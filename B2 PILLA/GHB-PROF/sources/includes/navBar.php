...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  <div class="container">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item <?=!isset($_SESSION['visiteur'])?'disabled':'';?>" href="#">Liste médicaments à présenter pour le mois</a></li>
          </ul>
        </li>
      <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item <?=!isset($_SESSION['chefregion'])?'disabled':'';?>" href="#">Attribution des produits à présenter</a></li>
            <li><a class="dropdown-item <?=!isset($_SESSION['chefregion'])?'disabled':'';?>" href="liste_visiteur.php">Liste des visiteurs médicaux</a></li>
          </ul>
      </li>
    ...
    <ul class="navbar-nav ms-auto">
      <li class="nav-item">
         <a class="nav-link">Bienvenue <?=isset($_SESSION['visiteur'])?unserialize($_SESSION['visiteur'])->prenom:'inconnu(e) sur notre site';?></a>
      </li>
      <li class="nav-item <?=$_SERVER['PHP_SELF']==='/seConnecter.php'?'active':''?>">
        <a class="nav-link" href="seConnecter.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="<?=isset($_SESSION['visiteur'])?'bi bi-door-closed-fill':'bi bi-door-closed-fill';?>" viewBox="0 0 16 16">
                <path d="<?=isset($_SESSION['visiteur'])?'M12 1a1 1 0 0 1 1 1v13h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V2a1 1 0 0 1 1-1h8zm-2 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2z':'M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z'?>"/>
            </svg>
            <?=isset($_SESSION['visiteur'])?' Déconnexion':' Login';?> 
        </a>
      </li>      
